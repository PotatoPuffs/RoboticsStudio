...
def generate_launch_description():
    launch_file_dir = os.path.join(get_package_share_directory('robotics_studio'), 'launch')
    ...
    world = os.path.join(
        get_package_share_directory('robotics_studio'),
        'worlds',
        'turtlebot3_house_cheese.world'
    )
